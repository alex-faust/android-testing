...
class TasksLocalDataSourceTest {
    ...
    fun setup() {
        ...
        //usually room doesn't allow database queries to be run on main thread
        //this turns the check off the check for that. never do this in production code

        localDataSource =
            TasksLocalDataSource(
                database.taskDao(),
                Dispatchers.Main //used in main because we are using allowMainThreadQueries
            )
    }
