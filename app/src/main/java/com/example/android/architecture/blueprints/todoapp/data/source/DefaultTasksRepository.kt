...
class DefaultTasksRepository (
    ...
    companion object {
        ...
        fun getRepository(app: Application): DefaultTasksRepository {
            return INSTANCE ?: synchronized(this) {
                //construct the database since you removed it from init block
    ...
    */
    ...
    /* removing these since we do not need to construct the dependencies anymore
    init {
